...
/**
 * @author TODO: B0444124 吳一潔 
 * Try to write some comments for your codes(methods, 10 points) 
 * 這是寫到第二階段的撲克牌21點遊戲程式碼， 會先請你輸入撲克牌的副數
 *         按下enter後會print出所有牌 所以輸入2，就會印出兩副牌(104張牌) 
 *         如果出現"Well done!"表示作業正確
 *         如果出現"All Card: Well done! But shufller is not working"表示洗牌失敗，作業只正確一半
 *         如果出現"Error, pleasecheck your sourse code"表示作業十分的失敗，要檢查程式碼
 */
public class HW3 {
	public static void main(String[] args) {
		...
		// TODO: please check your output, make sure that you print newCard and newCard2
		// on your screen (10 points)
